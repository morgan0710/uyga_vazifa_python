...
class  Customer(models.Model):
    ...
    phone = models.CharField(null=False, unique=True, blank=False, max_length=100)
    created_at = models.DateTimeField(auto_now_add=True)
    def __str__(self):
        return f"{self.first_name} {self.last_name}"

class Order(models.Model):
    payment_type = models.ImageField(null=False, blank=False)
    status = models.ImageField(null=False, blank=True, default='')
